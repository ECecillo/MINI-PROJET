...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto1_Simple
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto1_Simple.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto1_Simple
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto1_Simple.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto1_Simple.o: ../../apps/tutorials/tuto1_Simple.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
