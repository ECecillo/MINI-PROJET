...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/LIFAMI_1_Complex
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_1_Complex.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/LIFAMI_1_Complex
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_1_Complex.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
clean:
	@echo Cleaning LIFAMI_1_Complex
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TPComplex.o: ../../apps/LIFAMI/TPComplex.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
