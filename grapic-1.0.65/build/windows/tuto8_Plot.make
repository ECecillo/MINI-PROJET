...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto8_Plot
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto8_Plot.exe
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto8_Plot.o: ../../apps/tutorials/tuto8_Plot.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
