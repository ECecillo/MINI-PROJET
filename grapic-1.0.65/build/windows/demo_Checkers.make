...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/demo_Checkers
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/demo_Checkers.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/demo_Checkers
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/demo_Checkers.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main_checkers.o: ../../apps/demo_checkers/main_checkers.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
