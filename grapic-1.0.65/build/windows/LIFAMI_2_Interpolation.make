...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/LIFAMI_2_Interpolation
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_2_Interpolation.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/LIFAMI_2_Interpolation
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_2_Interpolation.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking LIFAMI_2_Interpolation
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning LIFAMI_2_Interpolation
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TPInterpolation.o: ../../apps/LIFAMI/TPInterpolation.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
