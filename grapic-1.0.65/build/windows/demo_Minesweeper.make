...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/demo_Minesweeper
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/demo_Minesweeper.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/demo_Minesweeper
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/demo_Minesweeper.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
clean:
	@echo Cleaning demo_Minesweeper
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main_minesweeper.o: ../../apps/demo_minesweeper/main_minesweeper.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
