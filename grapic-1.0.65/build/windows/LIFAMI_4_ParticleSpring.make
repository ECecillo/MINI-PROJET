...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/LIFAMI_4_ParticleSpring
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_4_ParticleSpring.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/LIFAMI_4_ParticleSpring
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/LIFAMI_4_ParticleSpring.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking LIFAMI_4_ParticleSpring
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning LIFAMI_4_ParticleSpring
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/TPParticleSpring.o: ../../apps/LIFAMI/TPParticleSpring.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
