...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto4_Keyboard
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto4_Keyboard.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto4_Keyboard
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto4_Keyboard.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto4_Keyboard.o: ../../apps/tutorials/tuto4_Keyboard.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
