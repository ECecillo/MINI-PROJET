...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto7_Animation
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto7_Animation.exe
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto7_Animation
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tuto7_Animation.exe
  DEFINES   += -DWIN32 -DNVWIDGETS_EXPORTS -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -DNOMINMAX
  INCLUDES  += -I../.. -I../../src -I../../extern/mingw/include -I../../extern/mingw/include/SDL2
...
$(OBJDIR)/Grapic.o: ../../src/Grapic.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto7_Animation.o: ../../apps/tutorials/tuto7_Animation.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
